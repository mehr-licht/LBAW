...
{ ?>
        ...
        <div class="modal fade" id="report" tabindex="-1" role="dialog" aria-labelledby="reportModelLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(url('/products/report/' . $product->id)); ?>"> 
                        <?php echo csrf_field(); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <hr><?php if (!$isauction && $product->state_product === 'active' || $product->state_product === 'bought')
    { ?>
            <div class="row" id="buyorpay">
                ...
                <div class="product-price col-md-2">Preço: <span class="font-propria-bold">
                    <?php echo e($buyitnow->final_value); ?>     
                    Eur </span>
                </div>

                <?php endif; ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('pay', $product)): ?>
    ...
    else
    {
        ...
        { ?>
            ...
            {
                $placeholder = $auction->bidding_base;
            } ?>
...
<br>
            ...
            <hr>
           <?php if($isauction){ ?>
            <div class="product-price">Preço: <span class="font-propria-bold">
           
            <?php echo e($auction->final_value); ?>
            ...
            <?php if(Auth::guard('admin')->check()): ?>
                <button id="remove-product" product="<?php echo e($product->id); ?>" remover="Auth::guard('admin')->getUser()"
            ...
            <a href="/products/<?php echo e($product->id); ?>/edit/">
                <button id="edit-product" product="<?php echo e($product->id); ?>" 
                                    type="button" class="btn btn-info pull-left">Editar</button></a>
                <button id="cancel-product" product="<?php echo e($product->id); ?>" 
                                    type="button" class="btn btn-secondary pull-left ml-3">Cancelar</button>
                <div class="clearfix"></div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button id="addBuy" product="<?php echo e($product->id); ?>" buyer="<?php echo e(Auth::id()); ?>" seller="<?php echo e($product->id_owner); ?>"
                ...
                <div class="col-md-10 col-md-offset-2 col-sm-12">
                    <div class="comment-wrapper">
                        <div class="panel panel-info">
                            ...
                            <?php if(Auth::guard('admin')->check() or Auth::check()): ?>
                                ...
                                <textarea id="commentText" class="form-control" placeholder="Escreva um comentário..."
                                    rows="3"></textarea>
                                <br>
                                <button id="addComment" product="<?php echo e($product->id); ?>" commenter="<?php echo e($commenter); ?>" liker=<?php echo e(Auth::id()); ?>
...
else
{
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/pages/product.blade.php ENDPATH**/ ?>