        ...
        <nav id="barra_menu" class="navbar navbar-expand-md ">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item dropdown"> 
                            <span id="Conta" style="color:white;">
                                ...
                                <?php elseif(Auth::guard('admin')->check()): ?>
                                    <?php echo e(Auth::guard('admin')->getUser()->username); ?>
                    ...
                    <li class="nav-item"><?php if(Auth::check() or Auth::guard('admin')->check()): ?>
                        <a class="nav-link" href="<?php echo e(url('/logout')); ?>">
                            <img src="../si-glyph-sign-outw.svg" style="width:25px;">
                            <?php else: ?>
                            <a class="nav-link"
...
<!---------------------------------------------- NAV END ------------------------------------------------>
<?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/includes/header.blade.php ENDPATH**/ ?>