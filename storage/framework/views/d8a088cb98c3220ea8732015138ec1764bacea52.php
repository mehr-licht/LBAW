        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <div class="row">
                ...
                <?php $__currentLoopData = array_slice($arts, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $art): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="carousel-item">
            <div class="row">
                ...
                <?php $__currentLoopData = array_slice($computers, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $computer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-4 col-lg-3">
          ...
          <div class="carousel-item">
            <div class="row">
                ...
                <?php $__currentLoopData = array_slice($comics, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>    
                    <div class="col-sm-4 col-lg-3">
            ...
            <div class="carousel-inner">
                            ...
                            <div class="col-6 col-sm-4 col-lg-2">
                                <a href="<?php echo e(url('/products', [ $dayOffersPlaneOne->id ])); ?>">
                                    <div class="container">
                                        ...
                                        <div class="row item-info">
                                                <h6><?php echo e($dayOffersPlaneOne->name_product); ?></h5>
                ...
                <div class="carousel-item">
                    <div class="row">
                        ...
                        <?php $__currentLoopData = $dayOffersPlaneTwos->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dayOffersPlaneTwo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-6 col-sm-4 col-lg-2">
                                <a href="<?php echo e(url('/products', [ $dayOffersPlaneTwo->id ])); ?>">
                                    <div class="container">
                                        ...
                                        <div class="row item-info">
                                                <h6><?php echo e($dayOffersPlaneTwo->name_product); ?></h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/pages/index.blade.php ENDPATH**/ ?>