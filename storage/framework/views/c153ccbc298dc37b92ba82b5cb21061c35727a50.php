                ...
                <div class="row justify-content-center">
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show active" id="recentes" role="tabpanel" aria-labelledby="recentes-tab">
                                <section id="cards">
                                    <?php echo $__env->renderEach('partials.product', $productsRecentes, 'product'); ?>
                                </section>                            
                            </div>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/pages/productsRecent.blade.php ENDPATH**/ ?>