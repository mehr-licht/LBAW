<?php $__env->startSection('css'); ?>
    ...
    <link rel="stylesheet" href="<?php echo e(url('/css/faq.css')); ?>">
                ...
                <div class="card">
                    ...
                    <div id="collapseSeis" class="collapse" aria-labelledby="headingSeis" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            <!---TODO-->> Só precisa seguir quatro passos para começar a vender:
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/pages/faq.blade.php ENDPATH**/ ?>