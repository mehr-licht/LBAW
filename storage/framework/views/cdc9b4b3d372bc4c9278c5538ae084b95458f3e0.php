...
<div class="row">
    ...
    <div class="col-10 col-md-5">
        ...
        <div id="textContact" class="container">
            ...
            <p> Para ajuda com a sua conta PayPal ou efectuar pagamentos com PayPal é melhor contactar o PayPal
                ...
                ao
                seleccionar Help & Contact no fundo de qualquer
    ...
    <div class="col-10 offset-1 col-md-5 offset-md-0">
        ...
        <div id="formMsgGoodbye" class="alert alert-success text-center"><?php echo e(Session::get('flash_message')); ?></div>
        <?php endif; ?>
...
<img src="Banner_01.png" class="img-fluid" alt="">
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/attempt2/lbaw2036/resources/views/pages/contact.blade.php ENDPATH**/ ?>