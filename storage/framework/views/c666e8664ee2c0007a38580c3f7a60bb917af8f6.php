    ...
    <li class="media">
        ...
        <div class="media-body">
            ...
            <p>
                ...
                <span class="text-muted pull-right"><button  style="background-color:#ffffff;border:0" ><img src="../like.svg" style="width:20px;" id="putLike" product="<?php echo e($product->id); ?>" comment="<?php echo e($comment->id_comment); ?>" liker="<?php echo e(Auth::id()); ?>"/></button>
                    <small class="text-muted" id="numberlikes" ><?php echo e($comment->comment_likes); ?><i>likes</i></small>
                </span></p>
        </div>

    </li>
</article><?php /**PATH /home/luis/git/A4S2/LBAW/wip/lbaw2036/resources/views/partials/comment.blade.php ENDPATH**/ ?>