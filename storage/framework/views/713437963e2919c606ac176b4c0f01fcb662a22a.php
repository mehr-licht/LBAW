            ...
            <div class="col-lg-8 col-md-8 col-xs-12 col-sm-8" id="list_products">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-xs-12 col-lg-8">
                            ...
                            <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #f8f9fa;">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="caros-tab" data-toggle="tab" href="#caros" role="tab"
                ...
                <div class="row justify-content-center">
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="caros" role="tabpanel" aria-labelledby="caros-tab">
                            <section id="cards">
                                <?php echo $__env->renderEach('partials.product', $productsExpensive, 'product'); ?>
                             </section>  
                        </div>
                    </div>

                    <div id="pagination">
                        <?php echo $productsExpensive->render(); ?>
                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/luis/git/A4S2/LBAW/lbaw2036/resources/views/pages/productsExpensive.blade.php ENDPATH**/ ?>