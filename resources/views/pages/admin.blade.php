...
@section('title')
@parent
&middot; Administration Dashboard
@stop
...
@section('content')
    ...
    <div class="container w-75 mb-4" id="admin_main_container" style="margin-top:60px;">
        <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color: #f8f9fa;">
            <li class="nav-item">
                <a class="nav-link active" id="denuncias-tab" data-toggle="tab" href="{{url('/admin/report')}}" role="tab" aria-controls="denuncias" aria-selected="true">Denúncias</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="hist_bans-tab" href="{{url('/admin/history')}}" aria-controls="hist_bans" aria-selected="false">Histórico Bans</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" id="add_admin-tab" href="{{url('/admin/add')}}" aria-controls="add_admin" aria-selected="false">Adicionar Admin</a>
            </li>
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade show active" id="denuncias" role="tabpanel" aria-labelledby="denuncias-tab">
                ...
                <hr>
                <form method="GET" class="form-inline" action="/admin/filter">
                    <label class="mr-2"><strong>Filtros:</strong></label>
                    <select class="custom-select my-1 mr-sm-2" id="selectAdminFilter" onchange="this.form.submit()" name="filter">
                        @if(!isset($filter) || $filter == "myDens")
                            <option value="myDens" selected>Minhas</option>
                        ...
                        @elseif($filter == "toBeSolved")
                            <option value="myDens">Minhas</option>
                            <option value="toBeSolved" selected>Assumir</option>
                            <option value="solving">Assumido</option>
                            <option value="solved">Resolvido</option>
                            <option value="byDays">+ Recentes</option>
                            <option value="byId">Id</option>
                        @elseif($filter == "solving")
                            <option value="myDens">Minhas</option>
                            <option value="toBeSolved">Assumir</option>
                            <option value="solving" selected>Assumido</option>
                            <option value="solved">Resolvido</option>
                            <option value="byDays">+ Recentes</option>
                            <option value="byId">Id</option>
                        @elseif($filter == "solved")
                            ...
                            <option value="byDays">+ Recentes</option>
                            <option value="byId">Id</option>
                        @elseif($filter == "byDays")
                            <option value="myDens">Minhas</option>
                            <option value="toBeSolved">Assumir</option>
                            <option value="solving">Assumido</option>
                            <option value="solved">Resolvido</option>
                            <option value="byDays" selected>+ Recentes</option>
                            <option value="byId">Id</option>
                        @else
                            <option value="myDens">Minhas</option>
                            <option value="toBeSolved">Assumir</option>
                            ...
                            <option value="solved">Resolvido</option>
                            <option value="byDays">+ Recentes</option>
                            <option value="byId" selected>Id</option>
                        @endif
                    </select>
                </form>
                <hr>
                <div class="list-group">
                    @each('partials.report', $report, 'report')                    
                </div>
